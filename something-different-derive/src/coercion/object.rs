                ...
                fn coerce(
                    ...
                    for item in query.items.iter() {
                        match item {
                            ...
                            ::tokio_gql::graphql_parser::query::Selection::FragmentSpread(_) => panic!("fragment spreads are unimplemented"),
                            ::tokio_gql::graphql_parser::query::Selection::InlineFragment(_) => panic!("inline fragments are unimplemented"),
